...
export function PortfolioObligationsDrawer({
  open,
  onClose,
  days = 30,
}: {
  ...
  const { data, isLoading, error, refetch } = usePortfolioObligations(days, 200);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            <div style={{ fontSize: "16px", fontWeight: 600, color: "rgb(var(--foreground))" }}>
              ...
              <table style={{ width: "100%", fontSize: "13px", borderCollapse: "collapse" }}>
                <thead style={{ background: "rgb(var(--muted))" }}>
                  <tr>
                    ...
                    <th style={{ padding: "12px 16px", textAlign: "left", fontWeight: 600, color: "rgb(var(--foreground))", fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.5px" }}>Loan</th>
                ...
                <tbody>
                  {(data?.obligations ?? []).map((o: ObligationDto, index: number) => (
                    ...
                    >
                      ...
                      <td style={{ padding: "16px", color: "rgb(var(--foreground))" }}>
                        <div style={{ fontWeight: 500 }}>{o.sourceType.replace("_", " ")}</div>
                      </td>
                    </tr>
                  ))}
                  {(data?.obligations?.length ?? 0) === 0 ? (
                    <tr>
                      <td style={{ padding: 24, color: "rgb(var(--muted-foreground))", textAlign: "center" }} colSpan={5}>
                        No obligations in the next {days} days.
                      </td>
                    </tr>
                  ) : null}
                </tbody>
